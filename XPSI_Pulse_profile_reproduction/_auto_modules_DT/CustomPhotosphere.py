""" Photosphere module for X-PSI PDT + NSX-H modelling of NICER Synthetic Source event data. """
...
class CustomPhotosphere(xpsi.Photosphere):
    ...
    def global_variables(self):
        ...
        return np.array([ref['super_colatitude'],
                          (ref['phase_shift'] + 0.0) * 2.0 * math.pi,
                          ref['super_radius'],
                          ref['cede_colatitude'],
                          (ref['phase_shift'] + 0.0) * 2.0 * math.pi + ref['cede_azimuth'],
                          ref['cede_radius'],
                          0.0,
                          0.0,
                          0.0,
