""" Instrument module for X-PSI PDT + NSX-H modelling of NICER Synthetic Source event data. """
...
class CustomInstrument(xpsi.Instrument):
    ...
    def XTI(cls,
        ...
        # template
# DEVARSHI: Uncommented the following block of code until next comment by me
...
#  DEVARSHI: Following code commented for 3c50 instrument files
#            and reverted to template
